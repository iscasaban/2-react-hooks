...
but that it uses other hooks inside of it. All a custom hook is is a function
that uses hooks. Those hooks can be built-in hooks like what we're doing here,
or they can be other custom hooks, so you can compose these things together.
